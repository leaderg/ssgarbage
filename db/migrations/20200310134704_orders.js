...
exports.up = function(knex) {
  return knex.schema.createTable('orders', function(t) {
    ...
    t.decimal('discount', 16, 4). defaultTo(0); // In cents
    t.decimal('subtotal', 16, 4).defaultTo(0); // In Cents
    t.decimal('tax', 16, 4).defaultTo(0); // In Cents
    t.decimal('total', 16, 4).defaultTo(0); // In Cents
  });
};
